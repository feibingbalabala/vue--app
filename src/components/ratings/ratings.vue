<template>
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <split></split>
            <ratingSelect @content-toggle="contentToggle" @ratingtype-select="ratingtypeSlect" :select-type="selectType" :only-content="onlyContent" :ratings="ratings"></ratingSelect>
